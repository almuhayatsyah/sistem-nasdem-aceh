...
export default function Create({ auth, dpds }) {
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                ...
                                <p className="mt-2 text-sm text-gray-600">
                                    Tambahkan data Dewan Pimpinan Cabang
                                    (Kecamatan) baru
                                </p>
                            </div>
                    ...
                    <div className="bg-white shadow-sm rounded-lg overflow-hidden">
                        <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                            ...
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                Isi data DPC baru di bawah ini
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="px-4 py-5 sm:p-6">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="Contoh: DPC Cilandak"
                                        required
                                    />
                                    <InputError
                            ...
                            <div className="flex items-center justify-end mt-8 pt-6 border-t border-gray-200">
                                ...
                                >
                                    ...
                                    {processing ? "Menyimpan..." : "Simpan DPC"}
                                </PrimaryButton>
                            </div>
                        </form>
                    </div>
                            ...
                            <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-blue-700">
                                    <p>
                                        ...
                                        Pastikan memilih DPD induk yang sesuai
                                        dengan wilayah DPC ini.
                                    </p>
                                </div>
                            </div>
                        </div>
