...
export default function Edit({ auth, kader, dpcs }) {
    const { data, setData, errors, put, processing } = useForm({
        dpc_id: kader.dpc_id || "",
        nama_lengkap: kader.nama_lengkap || "",
        nik: kader.nik || "",
        tempat_lahir: kader.tempat_lahir || "",
        tanggal_lahir: kader.tanggal_lahir || "",
        jenis_kelamin: kader.jenis_kelamin || "",
        agama: kader.agama || "",
        pekerjaan: kader.pekerjaan || "",
        email: kader.email || "",
        no_kta: kader.no_kta || "",
        tanggal_bergabung: kader.tanggal_bergabung || "",
        status_keanggotaan: kader.status_keanggotaan || "Aktif",
        jabatan: kader.jabatan || "Anggota Biasa",
        alamat_ktp: kader.alamat_ktp || "",
        alamat_domisili: kader.alamat_domisili || "",
        no_hp: kader.no_hp || "",
    });

    const submit = (e) => {
        e.preventDefault();
        put(route("kaders.update", kader.id));
    };
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <div className="flex items-center">
                            ...
                            <p className="text-sm text-blue-700">
                                Sedang mengedit data kader:{" "}
                                <strong>{kader.nama_lengkap}</strong> -{" "}
                                {kader.no_kta || "No KTA belum diisi"}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white shadow-sm rounded-lg overflow-hidden">
                        <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                            <h3 className="text-lg leading-6 font-medium text-gray-900">
                                Form Edit Data Kader
                            </h3>
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                Perbarui informasi kader sesuai kebutuhan
                            </p>
                        </div>
